...
PACKAGENAME = metadata.get('package_name', 'template')
DESCRIPTION = metadata.get('description', 'an astropy template for things')
AUTHOR = metadata.get('author', 'caganze')
...
if sys.version_info < tuple((int(val) for val in __minimum_python_version__.split('.'))):
    sys.stderr.write("ERROR: template requires Python {} or later\n".format(__minimum_python_version__))
    sys.exit(1)
